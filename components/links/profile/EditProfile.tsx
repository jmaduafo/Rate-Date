...
function EditProfile({ userData, loading, updateProfile, setName, name, setUsername, username, setBio, bio, setPronounsText, pronounsText, setOrientation, orientation, setIsPrivate, isPrivate, setBirthday, birthday, setRelationStatus, relationStatus }: EditProps) {
  return (
    <Sheet>
